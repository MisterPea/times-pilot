...
import BookmarkedArticleGroup from "../components/BookmarkedArticleGroup/BookmarkedArticleGroup";
import '../style/global.scss';
import { INITIAL_VIEWPORTS } from "@storybook/addon-viewport";

const meta: Meta<typeof BookmarkedArticleGroup> = {
  title: 'Article/Bookmarked Group',
  component: BookmarkedArticleGroup,
  parameters: {
    viewport: {
...
export default meta;
type Story = StoryObj<typeof BookmarkedArticleGroup>;
